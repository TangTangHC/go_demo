...
func (c *greeterClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
...
func (UnimplementedGreeterServer) Ping(context.Context, *emptypb.Empty) (*Pong, error) {
